...
@Component({
  selector: 'app-tienda-vacia-ind',
  standalone: true,
  imports: [CommonModule, CurrencyPipe, NgForOf, NgIf],
  templateUrl: './tienda-vacia-ind.component.html',
  styleUrls: ['./tienda-vacia-ind.component.css']
})
export class TiendaVaciaIndComponent implements OnInit {
  products: Product[] = [];
  ...
  noAddItems(): void {
    ...
    if (localStorage.getItem('inscripcionEquipo')) {
      ...
      inscripcion.productosOpcionales = "completo";
